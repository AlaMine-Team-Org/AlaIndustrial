...
<p><img alt="Ala Industrial Minecraft mod: the new item pipe runs between two chests, a teal nozzle on one end and an orange flange on the other" src="https://raw.githubusercontent.com/AlaMine-Team-Org/AlaIndustrial/v0.1.188-mc26.3/release-media/v0.1.188-mc26.3/changelog.png" width="720"></p>
