...
/**
 * Pure energy-distribution arithmetic used by {@link EnergyNetwork#tick()} — extracted so it can be
...
public final class EnergyShare {
	 ...
	 * @param lossPerBlock   fraction of throughput lost per cable block (≥ 0; copper ≈ 0.0125)
