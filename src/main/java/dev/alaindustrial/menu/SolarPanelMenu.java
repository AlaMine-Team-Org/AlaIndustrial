...
public class SolarPanelMenu extends MachineMenu {
	...
	public SolarPanelMenu(int syncId, Inventory playerInventory, MachineBlockEntity be, ContainerLevelAccess access) {
		super(ModMenus.SOLAR_PANEL, syncId, playerInventory, be, be.getDataAccess(), access, ModBlocks.SOLAR_PANEL);
	}

	/** Client side. */
	public SolarPanelMenu(int syncId, Inventory playerInventory) {
		super(ModMenus.SOLAR_PANEL, syncId, playerInventory, new SimpleContainer(1),
				new SimpleContainerData(6), ContainerLevelAccess.NULL, ModBlocks.SOLAR_PANEL);
	}
