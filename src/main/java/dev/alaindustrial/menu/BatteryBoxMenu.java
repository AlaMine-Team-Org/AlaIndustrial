...
public class BatteryBoxMenu extends MachineMenu {
	...
	public BatteryBoxMenu(int syncId, Inventory playerInventory, MachineBlockEntity be, ContainerLevelAccess access) {
		super(ModMenus.BATTERY_BOX, syncId, playerInventory, be, be.getDataAccess(), access, ModBlocks.BATTERY_BOX);
	}

	/** Client side. */
	public BatteryBoxMenu(int syncId, Inventory playerInventory) {
		super(ModMenus.BATTERY_BOX, syncId, playerInventory, new SimpleContainer(0),
				new SimpleContainerData(5), ContainerLevelAccess.NULL, ModBlocks.BATTERY_BOX);
	}
