...
public final class ModContent {
	...
	// MOD-513 — the lab plaque plates.
	public static Supplier<Block> ENGRAVED_PLATE_0 = unbound("ENGRAVED_PLATE_0");
	public static Supplier<Block> ENGRAVED_PLATE_1 = unbound("ENGRAVED_PLATE_1");
	public static Supplier<Block> ENGRAVED_PLATE_2 = unbound("ENGRAVED_PLATE_2");
	public static Supplier<Block> ENGRAVED_PLATE_3 = unbound("ENGRAVED_PLATE_3");
	public static Supplier<Block> ENGRAVED_PLATE_4 = unbound("ENGRAVED_PLATE_4");
	public static Supplier<Block> ENGRAVED_PLATE_5 = unbound("ENGRAVED_PLATE_5");
	public static Supplier<Block> ENGRAVED_PLATE_6 = unbound("ENGRAVED_PLATE_6");
	public static Supplier<Block> ENGRAVED_PLATE_7 = unbound("ENGRAVED_PLATE_7");
	public static Supplier<Block> ENGRAVED_PLATE_8 = unbound("ENGRAVED_PLATE_8");
	public static Supplier<Block> ENGRAVED_PLATE_9 = unbound("ENGRAVED_PLATE_9");
	public static Supplier<Block> BROKEN_ENGRAVED_PLATE_W = unbound("BROKEN_ENGRAVED_PLATE_W");
	public static Supplier<Block> BROKEN_ENGRAVED_PLATE_K = unbound("BROKEN_ENGRAVED_PLATE_K");
	public static Supplier<Block> BROKEN_ENGRAVED_PLATE_P = unbound("BROKEN_ENGRAVED_PLATE_P");
	public static Supplier<Block> BROKEN_ENGRAVED_PLATE_B = unbound("BROKEN_ENGRAVED_PLATE_B");
	public static Supplier<Block> BROKEN_ENGRAVED_PLATE_D = unbound("BROKEN_ENGRAVED_PLATE_D");
	public static Supplier<Block> BROKEN_ENGRAVED_PLATE_R = unbound("BROKEN_ENGRAVED_PLATE_R");
	public static Supplier<Block> BROKEN_ENGRAVED_PLATE_M = unbound("BROKEN_ENGRAVED_PLATE_M");
	...
	public static Supplier<BlockItem> ENGRAVED_PLATE_0_ITEM = unbound("ENGRAVED_PLATE_0_ITEM");
	public static Supplier<BlockItem> ENGRAVED_PLATE_1_ITEM = unbound("ENGRAVED_PLATE_1_ITEM");
	public static Supplier<BlockItem> ENGRAVED_PLATE_2_ITEM = unbound("ENGRAVED_PLATE_2_ITEM");
	public static Supplier<BlockItem> ENGRAVED_PLATE_3_ITEM = unbound("ENGRAVED_PLATE_3_ITEM");
	public static Supplier<BlockItem> ENGRAVED_PLATE_4_ITEM = unbound("ENGRAVED_PLATE_4_ITEM");
	public static Supplier<BlockItem> ENGRAVED_PLATE_5_ITEM = unbound("ENGRAVED_PLATE_5_ITEM");
	public static Supplier<BlockItem> ENGRAVED_PLATE_6_ITEM = unbound("ENGRAVED_PLATE_6_ITEM");
	public static Supplier<BlockItem> ENGRAVED_PLATE_7_ITEM = unbound("ENGRAVED_PLATE_7_ITEM");
	public static Supplier<BlockItem> ENGRAVED_PLATE_8_ITEM = unbound("ENGRAVED_PLATE_8_ITEM");
	public static Supplier<BlockItem> ENGRAVED_PLATE_9_ITEM = unbound("ENGRAVED_PLATE_9_ITEM");
	public static Supplier<BlockItem> BROKEN_ENGRAVED_PLATE_W_ITEM = unbound("BROKEN_ENGRAVED_PLATE_W_ITEM");
	public static Supplier<BlockItem> BROKEN_ENGRAVED_PLATE_K_ITEM = unbound("BROKEN_ENGRAVED_PLATE_K_ITEM");
	public static Supplier<BlockItem> BROKEN_ENGRAVED_PLATE_P_ITEM = unbound("BROKEN_ENGRAVED_PLATE_P_ITEM");
	public static Supplier<BlockItem> BROKEN_ENGRAVED_PLATE_B_ITEM = unbound("BROKEN_ENGRAVED_PLATE_B_ITEM");
	public static Supplier<BlockItem> BROKEN_ENGRAVED_PLATE_D_ITEM = unbound("BROKEN_ENGRAVED_PLATE_D_ITEM");
	public static Supplier<BlockItem> BROKEN_ENGRAVED_PLATE_R_ITEM = unbound("BROKEN_ENGRAVED_PLATE_R_ITEM");
	public static Supplier<BlockItem> BROKEN_ENGRAVED_PLATE_M_ITEM = unbound("BROKEN_ENGRAVED_PLATE_M_ITEM");
