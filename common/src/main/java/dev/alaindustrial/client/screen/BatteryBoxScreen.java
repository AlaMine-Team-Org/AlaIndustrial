...
public class BatteryBoxScreen extends MachineScreen<BatteryBoxMenu> {
    ...
    protected void drawMachineFrame(GuiGraphicsExtractor graphics, int mouseX, int mouseY,
        ...
        // NOTE: blitStaticFrame() is called in the MIDDLE here, not at the top — the orange fill must
        // be laid down first so the frame's transparent interior reveals the battery segments.
