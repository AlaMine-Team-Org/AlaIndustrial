...
public final class MenuScreenManifest {
	...
	public static final List<ScreenDef<?, ?>> SCREENS = List.of(
			...
			screen(() -> ModContent.FERMENTER_MENU.get(), FermenterScreen::new),
			screen(() -> ModContent.SPRINKLER_MENU.get(), SprinklerScreen::new),
			...
			screen(() -> ModContent.DIAMOND_CHEST_MENU.get(), DiamondChestScreen::new),
			screen(() -> ModContent.SHIELDING_CHEST_MENU.get(), ShieldingChestScreen::new),
