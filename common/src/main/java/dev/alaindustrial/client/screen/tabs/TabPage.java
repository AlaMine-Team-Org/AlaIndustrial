...
/**
 * One tab of a screen whose tabs run down its left edge (MOD-617, generalised in MOD-628).
 *
 * <p>The screen owns the frame every tab shares — the panel, the {@link SideTabStrip} and whatever the header
 * carries — and hands the rest of the panel to whichever page is selected. A page never draws the frame and
 * never decides which page is showing.
 */
