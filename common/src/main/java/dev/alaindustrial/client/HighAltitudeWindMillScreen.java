...
/**
 * Texture-backed screen for the High-Altitude Wind Mill (T2, LV). Static frame from the wind-mill
 * GUI atlas; dynamic layer draws the energy fill (bottom-up orange bar). No evolution bar — the T2
 * mill is a leaf tier. A read-only energy display like the T2 solar-panel screens.
 */
