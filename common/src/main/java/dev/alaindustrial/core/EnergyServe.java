...
/**
 * Pure long-math extraction from {@link EnergyNetwork#serveClass} (MOD-144), the runtime counterpart
 ...
 * the runtime transport path (inside the {@code serveClass} loop), so a single {@code +→−} or
 * {@code −→+} mutation there is the canonical EU-creation / EU-destruction bug — and because
 * {@link EnergyNetwork} is a MC-coupled class excluded from pitest (it references
 ...
 *
 * <p><b>Behavioural identity.</b> {@link EnergyNetwork#serveClass} calls these helpers verbatim. The
 ...
 * {@link TankMath}/{@link EnergyShare} extraction pattern.
 *
