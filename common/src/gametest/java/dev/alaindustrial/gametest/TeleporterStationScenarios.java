...
public final class TeleporterStationScenarios {
	...
	private static TeleporterBlockEntity place(GameTestHelper helper) {
		return AlaGameTestHelper.place(helper, POS, ModContent.TELEPORTER.get(), TeleporterBlockEntity.class);
	}
	 ...
	 * @covers R-NRG-01
	 */
	public static void tcTele001Fun01_acceptsButNeverEmits(GameTestHelper helper) {
	 ...
	 */
	public static void tcTele001Fun02_bufferMatchesConfig(GameTestHelper helper) {
		TeleporterBlockEntity station = place(helper);
	 ...
	 */
	public static void tcTele001Fun03_hvIntakeRate(GameTestHelper helper) {
		TeleporterBlockEntity station = place(helper);
	 ...
	 * @covers R-NRG-03
	 */
	public static void tcTele001Nrg03_frontFaceInert(GameTestHelper helper) {
		TeleporterBlockEntity station = place(helper);
	 ...
	 * @covers R-PER-01
	 */
	public static void tcTele001Per01_stateSurvivesNbt(GameTestHelper helper) {
		TeleporterBlockEntity station = place(helper);
	 ...
	 */
	public static void tcTele001Per02_defaultsToPrivate(GameTestHelper helper) {
		TeleporterBlockEntity station = place(helper);
	 ...
	 * @covers R-BRK-07
	 */
	public static void tcTele001Brk07_dropCarriesEnergyAndPrivacyButNotOwner(GameTestHelper helper) {
		TeleporterBlockEntity station = place(helper);
		station.setOwner(OWNER, "Steve");
		station.setPrivate(false);
	 ...
	 */
	public static void tcTele001Sec01_privacyGate(GameTestHelper helper) {
		TeleporterBlockEntity station = place(helper);
		station.setOwner(OWNER, "Steve");
	 ...
	 */
	public static void tcTele001Con01_isAStorageSink(GameTestHelper helper) {
		TeleporterBlockEntity station = place(helper);
	 ...
	 * @covers R-NRG-01
	 */
	public static void tcTele001Con02_doesNotStarveMachines(GameTestHelper helper) {
		...
		helper.setBlock(macPos, ModContent.MACERATOR.get());
		helper.setBlock(telePos, ModContent.TELEPORTER.get().defaultBlockState()
