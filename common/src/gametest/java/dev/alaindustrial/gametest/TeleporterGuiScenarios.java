...
public final class TeleporterGuiScenarios {
	 ...
	 */
	public static void tcTele003Sec01_indexBoundsAreExact(GameTestHelper helper) {
	 ...
	 */
	public static void tcTele003Sec02_renameClampsName(GameTestHelper helper) {
	 ...
	 */
	public static void tcTele003Sec04_wireCarriesLegacyLengthNames(GameTestHelper helper) {
	 ...
	 */
	public static void tcTele003Fun01_listIsImmutable(GameTestHelper helper) {
	 ...
	 */
	public static void tcTele003Fun02_dedupeByDimAndPos(GameTestHelper helper) {
	 ...
	 */
	public static void tcTele003Fun03_limitIsTheConfiguredOne(GameTestHelper helper) {
	 ...
	 */
	public static void tcTele003Fun05_autoNamesTakeTheLowestFreeNumber(GameTestHelper helper) {
		ResourceKey<Level> here = helper.getLevel().dimension();
		TeleportPoints points = TeleportPoints.EMPTY;
		for (int i = 0; i < 3; i++) {
	 ...
	 *     changes nothing.
	 */
	public static void tcTele003Sec03_onlyOwnerTogglesPrivacy(GameTestHelper helper) {
